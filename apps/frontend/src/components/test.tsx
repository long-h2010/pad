import { Avatar, Badge, Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, styled, Typography } from '@mui/material';
...
function Test() {
    ...
    return (
        <>
            <Box onClick={handleDetailUser} sx={{ display: 'flex', alignItems: 'center', paddingBottom: 1, cursor: "pointer" }}>
                <StyledBadgeOnline
                    overlap='circular'
